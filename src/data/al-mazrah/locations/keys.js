...
export const keys = [
	{
		...
		keyName: "Ahmed Grocery Store Office Key",
		location: { x: 3056, y: 2220 },
		description: ["Easy to find, this is the office room inside of the grocery store."],
		video: "xfyHNVdPqQs",
	},
	{
		title: "Airport Maintenance",
		location: { x: 2941, y: 2874 },
		description: [
	...
	},
	{
		...
		keyName: "Police Locker Master Key",
